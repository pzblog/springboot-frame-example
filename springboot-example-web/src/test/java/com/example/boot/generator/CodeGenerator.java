package com.example.boot.generator;
...
public class CodeGenerator {
    ...
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/test-api?useUnicode=true&useSSL=false&characterEncoding=utf8";
    private static final String JDBC_USERNAME = "root";
    private static final String JDBC_PASSWORD = "Hello@123456";
     ...
     * 项目位置
     */
    private static final String projectPath = System.getProperty("user.dir");//项目在硬盘上的基础路径
    /**
     * 生成类文件存放位置
     */
     ...
     * 模块结构（模块路径）
     */
    private static final String modulePath = "com.company.project";
	...
	public static void main(String[] args) {
        ...
        // 数据源配置
        DataSourceConfig dsc = new DataSourceConfig().setUrl(JDBC_URL)
